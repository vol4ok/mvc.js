$.ns("mvc", function(exports) {
  ...
  Module = function() {
    ...
    Module.mixin = function(klass) {
      ...
      if (!klass) throw "mixin(klass) requires klass";
      this.include(klass.prototype);
      if ((_base = this.prototype)._mixins == null) _base._mixins = {};
  ...
  Controller = function(_super) {
    ...
    Controller.prototype["import"] = function(imports) {
      var id, name, _i, _len, _results, _results2;
      if (!imports) return;
      if ($.isArray(imports)) {
        _results = [];

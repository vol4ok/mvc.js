$.ns("mvc", function(exports) {
  ...
  Controller = function(_super) {
    ...
    Controller.prototype._delegateEvents = function(events) {
      ...
      for (src in events) {
        ...
        _results.push($$(srcId).on(event, $$(trgId)[method]));
      }
      return _results;
    };
  ...
  View = function(_super) {
    ...
    function View(options) {
      var key, value, _ref, _ref2, _this = this;
      if (options == null) options = {};
      this.release = $.bind(this.release, this);
      if (this.cid == null) {
        this.cid = options.id || ((_ref = options.el) != null ? _ref.id : void 0) || $.uniqId(this.cidPrefix);
      }
      registerObject(this.cid, this);
      ...
      if (this.id) this.attr("id", this.id);
